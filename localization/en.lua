...
ICDT.loc.settings.itemDescriptionDetailed =
		"PVP: |cd5b526Uncracked Transmutation Geode|r\nYou get this transmutation geode from the PvP mail reward 'Rewards for the Worthy'. Every day you have a save drop of this geode. As long as the cooldown is active your chance will be lower to get a geode out of the reward.\n\n" ..
		...
		"Dragonhold: |cd5b526Shield of Senchal Style Pages|r\nYou have a chance to receive a style page by completing the daily quests (delve or world boss) from the quest givers 'Guybert Flaubert' or 'Bruccius Baenius' in Senchal. After receiving a style page, there is a cooldown until the next server reset time, during which the chance of receiving additional style pages is significantly lower.\n\n" ..
		"Dragonhold: |cd5b526Dragonguard Style Pages|r\nYou have a chance to receive a style page by completing the daily quests from the quest givers 'Dirge Truptor' or 'Chizbari the Chipper' on Tideholm. After receiving a style page, there is a cooldown until the next server reset time, during which the chance of receiving additional style pages is significantly lower.\n\n" ..
		...
		"Greymoor: |cd5b526Blackreach Vanguard Style Pages|r\nYou have a chance to receive a style page by completing the daily quests (delve or world boss) from the quest givers 'Tinzen' or 'Hidaver' in Western Skyrim. After receiving a style page, there is a cooldown until the next server reset time, during which the chance of receiving additional style pages is significantly lower.\n\n" ..
		"Greymoor: |cd5b526Greymoor Style Pages|r\nYou have a chance to receive a style page by completing the daily quest (harrowstorm) from quest giver 'Jylta' in Western Skyrim. After receiving a style page, there is a cooldown until the next server reset time, during which the chance of receiving additional style pages is significantly lower.\n\n" ..
		"Markarth: |cd5b526Arkthzand Armory Style Pages|r\nYou have a chance to receive a style page by completing the daily quests (delve or world boss) from the quest givers 'Bralthahan' or 'Gwenyfe' in the Reach. After receiving a style page, there is a cooldown until the next server reset time, during which the chance of receiving additional style pages is significantly lower.\n\n" ..
		"Markarth: |cd5b526Nighthollow Style Pages|r\nYou have a chance to receive a style page by completing the daily quest (harrowstorm) from quest giver 'Nelldena' in the Reach. After receiving a style page, there is a cooldown until the next server reset time, during which the chance of receiving additional style pages is significantly lower.\n\n" ..
		...
		"Blackwood: |cd5b526Black Fin Legion Style Pages|r\nYou have a chance to receive a style page by completing the daily quest (delve) from quest giver 'Deetum-Jas' in Blackwood. After receiving a style page, there is a cooldown until the next server reset time, during which the chance of receiving additional style pages is significantly lower.\n\n" ..
		"Blackwood: |cd5b526Ivory Brigade Style Pages|r\nYou have a chance to receive a style page by completing the daily quest (world boss) from quest giver 'Britta Silanus' in Blackwood. After receiving a style page, there is a cooldown until the next server reset time, during which the chance of receiving additional style pages is significantly lower.\n\n" ..
		"Deadlands: |cd5b526House Hexos Style Pages|r\nYou have a chance to receive a style page by completing the daily quests (delve) from quest giver 'Luna Beriel' in Fargrave. After receiving a style page, there is a cooldown until the next server reset time, during which the chance of receiving additional style pages is significantly lower.\n\n" ..
		"Deadlands: |cd5b526Fargrave Guardian Style Pages|r\nYou have a chance to receive a style page by completing the daily quests (world boss) from quest giver 'Vaveli Indavel' in Fargrave. After receiving a style page, there is a cooldown until the next server reset time, during which the chance of receiving additional style pages is significantly lower.\n\n" ..
		"Deadlands: |cd5b526Annihilarch's Chosen Style Pages|r\nYou have a chance to receive a style page when opening the reward chest after you killed the final boss in a portal ('Atoll of Immolation') in the Deadlands. After receiving a style page, there is a cooldown until the next server reset time, during which the chance of receiving additional style pages is significantly lower (or even not possible).\n\n" ..		
		"High Isle: |cd5b526Steadfast Society Style Pages|r\nYou have a chance to receive a style page by completing the daily quests (world boss) from quest giver 'Parisse Plouff' in High Isle. After receiving a style page, there is a cooldown until the next server reset time, during which the chance of receiving additional style pages is significantly lower.\n\n" ..
		"High Isle: |cd5b526Systres Guardian Style Pages|r\nYou have a chance to receive a style page by completing the daily quests (delve) from quest giver 'Wayllod' in High Isle. After receiving a style page, there is a cooldown until the next server reset time, during which the chance of receiving additional style pages is significantly lower.\n\n"
