...
ICDT.loc.settings.itemDescriptionDetailed =
		--"PVP: |cd5b526Intakte Transmutationsgeode|r\nDu erhälst diese Transmutationsgeode von der PvP-Mail-Belohnung 'Gerechter Lohn'. Alle 20 Stunden hast du einen sicheren Drop. Solange der Cooldown aktiv ist, ist deine Chance, eine Transmutationsgeode aus der Belohnung zu erhalten, geringer.\n\n" ..
		--"PVP: |cd5b526Beweis des Arenagladiatoren|r\nDu erhältst dieses Fragment, indem du die täglichen Quests von der Missionstafel für Eroberungen in Cyrodiil abschließt ('Rucksack des Gladiatoren'). Du kannst mehrere dieser Quests pro Tag erledigen, aber das Fragment droppt nur einmal alle 20 Stunden.\n\n" ..
		--"PVP: |cd5b526Meriten der Belagerung von Cyrodiil|r\nDu erhältst diesen Fragment, indem du die täglichen PvE-Quests in der Kaiserstadt abschließt ('Kassette des Belagerungsmeisters'). Du kannst mehrere dieser Quests (für jeden Distrikt) pro Tag abschließen, aber das Fragment droppt nur einmal alle 20 Stunden.\n\n" ..
		--"Misc: |cd5b526Beute von 'Schweigt-still'|r\nWenn du den passiven Skill 'Verhüllter Versorger' (Dunkle Bruderschaft) freigeschaltet hast, findest du den NPC in jedem Gesetzlosen-Unterschlupf (Dunkle Bruderschaft Symbol). Einmal alle 20 Stunden kannst du dort Tränke, Ausrüstung, Erlasse und mehr anfordern.\n\n" ..
		"Dragonhold: |cd5b526Schilde von Senchal Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die täglichen Quests (Gewölbe oder Weltenboss) der Questgeber 'Guybert Flaubert' oder 'Bruccius Baenius' in Senchal abschließt. Nach dem Erhalt einer Stilseite gibt es einen Cooldown von 20 Stunden, während der die Chance, weitere Stilseiten zu erhalten, deutlich geringer ist.\n\n" ..
		"Dragonhold: |cd5b526Drachengarde Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die täglichen Quests der Questgeber 'Dirge Truptor' oder 'Chizbari die Hauerin' auf der Gezeiteninsel abschließt. Nach dem Erhalt einer Stilseite gibt es einen Cooldown von 20 Stunden, während der die Chance, weitere Stilseiten zu erhalten, deutlich geringer ist.\n\n" ..
		--"Dragonhold: |cd5b526Stilseiten: Priester des Neuen Mondes|r\nWenn du die Voraussetzungen erfüllt hast (Haupt-Quest), kannst du einmal am Tag eine Kiste auf der Gezeiteninsel direkt vor dem Questgeber 'Dirge Truptor' plündern. Die Kiste wird täglich zur gleichen Zeit zurückgesetzt, aber die Stilseiten können nur einmal alle 20 Stunden gefunden werden (kein sicherer Drop!).\n\n" ..
		"Greymoor: |cd5b526Schwarzweite-Vorhut Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die täglichen Quests (Gewölbe oder Weltenboss) der Questgeber 'Tinzen' oder 'Hidaver' im Westlichen Himmelsrand abschließt. Nach dem Erhalt einer Stilseite gibt es einen Cooldown von 20 Stunden, während der die Chance, weitere Stilseiten zu erhalten, deutlich geringer ist.\n\n" ..
		"Greymoor: |cd5b526Graumoor Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die tägliche Quest (Gramsturm) vom Questgeber 'Jylta' im Westlichen Himmelsrand abschließt. Nach dem Erhalt einer Stilseite gibt es einen Cooldown von 20 Stunden, während der die Chance, weitere Stilseiten zu erhalten, deutlich geringer ist.\n\n" ..
		"Markarth: |cd5b526Waffenkammer von Arkthzand Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die täglichen Quests (Gewölbe oder Weltenboss) der Questgeber 'Bralthahan' oder 'Gwenyfe' im Reik abschließt. Nach dem Erhalt einer Stilseite gibt es einen Cooldown von 20 Stunden, während der die Chance, weitere Stilseiten zu erhalten, deutlich geringer ist.\n\n" ..
		"Markarth: |cd5b526Nachttiefen Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die tägliche Quest (Gramsturm) vom Questgeber 'Nelldena' im Reik abschließt. Nach dem Erhalt einer Stilseite gibt es einen Cooldown von 20 Stunden, während der die Chance, weitere Stilseiten zu erhalten, deutlich geringer ist.\n\n" ..
		"Markarth: |cd5b526Unbezähmbare Hüter Stilseiten|r\nWenn du die Voraussetzungen erfüllt hast (Haupt-Quest Markarth), kannst du tägliche Quest vom Questgeber 'Ardanir' im Reik abschließen. Mit der Quest-Belohnung hast du die Chance, eine Stilseite zu erhalten. Nachdem du eine Stilseite erhalten hast, hast du einen Cooldown von 20 Stunden, während der die Chance, weitere Stilseiten zu erhalten, deutlich geringer ist.\n\n" ..
		"Blackwood: |cd5b526Schwarzflossen-Legion Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die tägliche Quest (Gewölbe) vom Questgeber 'Deetum-Jas' in Dunkelforst abschließt. Nach dem Erhalt einer Stilseite gibt es einen Cooldown von 20 Stunden, während der die Chance, weitere Stilseiten zu erhalten, deutlich geringer ist.\n\n" ..
		"Blackwood: |cd5b526Elfenbeinbrigade Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die tägliche Quest (Weltenboss) vom Questgeber 'Britta Silanus' in Dunkelforst abschließt. Nach dem Erhalt einer Stilseite gibt es einen Cooldown von 20 Stunden, während der die Chance, weitere Stilseiten zu erhalten, deutlich geringer ist.\n\n" ..
		"Deadlands: |cd5b526Haus Hexos Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die tägliche Quest (Gewölbe) vom Questgeber 'Luna Beriel' in Ferngrab abschließt. Nach dem Erhalt einer Stilseite gibt es einen Cooldown von 20 Stunden, während der die Chance, weitere Stilseiten zu erhalten, deutlich geringer ist.\n\n" ..
		"Deadlands: |cd5b526Ferngrabwächter Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die tägliche Quest (Weltenboss) vom Questgeber 'Vaveli Indavel' in Ferngrab abschließt. Nach dem Erhalt einer Stilseite gibt es einen Cooldown von 20 Stunden, während der die Chance, weitere Stilseiten zu erhalten, deutlich geringer ist.\n\n" ..
		"Deadlands: |cd5b526Auserwählten des Annihilarchen Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, beim Öffnen der Belohnungstruhe nach dem Erlegen des Endbosses in einem Portal ('Das Atoll der Selbstaufopferung') in den Totenländern. Nach dem Erhalt einer Stilseite gibt es einen Cooldown von 20 Stunden, während der die Chance, weitere Stilseiten zu erhalten, deutlich geringer (vielleicht auch gar nicht möglich) ist.\n\n" ..
		"High Isle: |cd5b526Liga der Standhaften Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die tägliche Quest (Weltenboss) vom Questgeber 'Parisse Plouff' in Hochinsel abschließt. Nach dem Erhalt einer Stilseite gibt es einen Cooldown von 20 Stunden, während der die Chance, weitere Stilseiten zu erhalten, deutlich geringer ist.\n\n" ..
		"High Isle: |cd5b526Systren-Wächter Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die tägliche Quest (Gewölbe) vom Questgeber 'Wayllod' in Hochinsel abschließt. Nach dem Erhalt einer Stilseite gibt es einen Cooldown von 20 Stunden, während der die Chance, weitere Stilseiten zu erhalten, deutlich geringer ist.\n\n"
